...
7. On the next screen, click `Browse` under `SPFL24_setup.exe` and select the `SPFL24_setup.exe` from the files you extracted step 2. Click `Continue` and wait for the various files to download.
